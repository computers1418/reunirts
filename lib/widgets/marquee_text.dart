      ...
      itemBuilder: (_, i) {
        final text = i.isEven
            ? Row(
                ...
                children: [
                  const Padding(
                    padding: EdgeInsets.only(bottom: 4, left: 2, right: 2),
                    child: Icon(Icons.star_rounded, color: Color(0xFFFFFFFF), size: 14,),
                  ),
                  Text("Limited - time offer ", style: TextStyle(
                          fontFamily: "Metropolis",
                          fontWeight: FontWeight.w600,
                          fontSize: ResponsiveText.get(context, 12),
                          color: Colors.white
                        )),
                  const Padding(
                    padding: EdgeInsets.only(bottom: 4, left: 2, right: 2),
                  ...
                  RichText(
                    text: TextSpan(
                      children: [
                        TextSpan(text:"Treatment starting at ", style: TextStyle(
                          fontFamily: "Metropolis",
                          fontWeight: FontWeight.w600,
                          fontSize: ResponsiveText.get(context, 12),
                          color: Colors.white
                        ...
                        TextSpan(text:" ₹200/-", style: TextStyle(
                          ...
                          fontSize: ResponsiveText.get(context, 14),
                          height: 1,
                          color: const Color(0xFFFFFFFF)
                        )),
                        TextSpan(text:" and get ", style: TextStyle(
                          fontFamily: "Metropolis",
                          fontWeight: FontWeight.w600,
                          fontSize: ResponsiveText.get(context, 12),
                          color: Colors.white
                        )),
                        TextSpan(text:" 50% discount ", style: TextStyle(
                          fontFamily: "Metropolis",
                          fontWeight: FontWeight.w700,
                          fontSize: ResponsiveText.get(context, 14),
                          color: const Color(0xFFFFFFFF)
                        )),
                        TextSpan(text:"and take good care of your health today !", style: TextStyle(
                          fontFamily: "Metropolis",
                          fontWeight: FontWeight.w600,
                          fontSize: ResponsiveText.get(context, 12),
                          color: Colors.white
