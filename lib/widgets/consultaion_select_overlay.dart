...
class ConsultationSelectOverlay extends StatefulWidget {
  const ConsultationSelectOverlay({super.key});

  @override
  State<ConsultationSelectOverlay> createState() => _ConsultationSelectOverlayState();
}

class _ConsultationSelectOverlayState extends State<ConsultationSelectOverlay> {
        ...
        child: InkWell(
          ...
          child: Container(
            ...
            child: Row(
              ...
              children: [
                Text(
                  selected.value ?? "Choose Consultation",
                  style: TextStyle(
      ...
      builder: (context) => Stack(
        children: [
          ...
          Positioned(
            ...
            left: 30,
            right: 30,
            bottom: (MediaQuery.of(context).size.height - (top+220))<=0 
              ? null
              : (MediaQuery.of(context).size.height - (top+220)),
            child: Material(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return InkWell(
                      ...
                      child: ValueListenableBuilder(
                        ...
                        builder: (_, val, __) {
                          return ConsultationItem(isSelected: selected.value==item, name: item);
                        }
                      ),
                    );
                  },
